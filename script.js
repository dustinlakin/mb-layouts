...
(function() {
  var Slider, bet_transition, bet_transition_back,
    _this = this,
  ...
  $(document).ready(function() {
    ...
    $(".event_left").on("click", function() {
      return bet_transition(this);
    });
    $(".back_button").on("click", function() {
      return bet_transition_back(this);
    });
  ...
  bet_transition = function(el) {
    return $(el).parent().animate({
      "margin-left": -315
    });
  };

  bet_transition_back = function(el) {
